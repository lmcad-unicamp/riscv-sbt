...
LOWRISC_LLVM_DEBUG_CONFIGURE := \
    $(CMAKE) \
             ...
             -DDEFAULT_SYSROOT=$(RISCV_GNU_TOOLCHAIN_PREFIX)/$(RV32_TRIPLE) \
             -DGCC_INSTALL_PREFIX=$(RISCV_GNU_TOOLCHAIN_PREFIX) \
             -DLLVM_DEFAULT_TARGET_TRIPLE=$(RV32_TRIPLE) \
...
LOWRISC_LLVM_DEBUG_DEPS := \
    $(if $(shell test -f $(RISCV_GNU_TOOLCHAIN_TOOLCHAIN) && echo 1),\
         ,$(RISCV_GNU_TOOLCHAIN_TOOLCHAIN)) \
    $(CLANG_LINK)
